...
Pull it down:
git clone https://github.com/mostlyclicks/wb10.git name_of_your_app
...
1. Replace wb10 with name_of_your_app (~9 occurences, 4 files)
2. Replace Wb10 with NameOfYourApp (~11 occurences, 10 files)
